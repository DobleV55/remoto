...
import time
import click
GROUP1 = ['user', 'user0', 'user1', 'user2', 'user3', 'user4', 'user5']
GROUP2 = ['user6', 'user7', 'user8', 'user9', 'user10', 'user11', 'user12']
GROUP3 = ['user13', 'user14', 'user15', 'user16', 'use17', 'user18', 'user19']
GROUP4 = ['user20', 'user21', 'user22', 'user23', 'user24', 'user25', 'user26']
...
def choose_remoto_days(groups, current_month_days):
   ...
   for members in GROUPS:
     for member in members:
           remoto_1 = (random.choice(first_half))
           usados[remoto_1] += 1
           if usados[remoto_1] == 3:
               first_half.remove(remoto_1)
           remoto_2 = (random.choice(second_half))
           usados[remoto_2] += 1
